...
\newcommand{\Keywords}{\ac{NLP}, Word Embedding, Transformers, FastText, \ac{RAG}, \ac{QA}, \ac{STS}}
\newcommand{\KlicovaSlova}{Zpracování přirozeného jazyka, Word Embedding, Transformátory, FastText, \ac{RAG}, \ac{QA}, Sémantická Podobnost Textu}
\newcommand{\Year}{2024}
\newcommand{\Month}{May}
