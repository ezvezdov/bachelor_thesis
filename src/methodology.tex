...
\begin{table}[!ht]
  \centering
  \input{src/tables/UPV_ntests.tex}
...
\begin{enumerate}
  ...
  \item \textbf{Popular Monolingual Models from the \ac{MTEB} (rank is lower than 100)}:
...
\begin{itemize}
  ...
  \item \textbf{paraphrase-multilingual-MiniLM-L12-v2}: This pre-trained model focuses on paraphrase identification.
    It is a multilingual version of the paraphrase-MiniLM-L12-v2 model, trained on parallel datasets encompassing over 50 languages, including Czech.
    By learning paraphrase relationships, this model can potentially capture semantic similarities between sentences.
  \item \textbf{paraphrase-multilingual-mpnet-base-v2}: Similar to the previous model, this is a multilingual version of the paraphrase-mpnet-base-v2 model, trained on parallel data for over 50 languages, including Czech.
