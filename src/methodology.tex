...
% Multilingual models
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{mBERT-base \cite{bert_mbert}}
\ac{mBERT} leverages the same transformer-based architecture as the original \ac{BERT} model but boasts an increased number of parameters (178M) to enhance its capabilities.
...
These models are available in three variants — small (118M parameters), base (278 parameters), and large (560M parameters) — catering to different computational efficiency and performance needs.
