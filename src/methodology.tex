...
\subsubsection{SentenceTransformers multilingual models \cite{reimers-2019-sentence-bert}} \label{model:st-multilingual}
...
The UAE-Large-V1 model \cite{UAE-Large-V1} focuses on enhancing short and long \ac{STS} tasks through a novel angle-optimized text embedding approach that works by dividing text embeddings into real and imaginary components in a complex space.
